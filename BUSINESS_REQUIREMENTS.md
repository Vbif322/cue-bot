...
#### 4.6.2 Назначение столов на матчи

- Администратор может назначить конкретный стол для каждого матча
- Участники видят номер стола в уведомлении о предстоящем матче
